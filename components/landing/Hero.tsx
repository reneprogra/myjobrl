  ...
  return (
    <section className="min-h-screen overflow-hidden relative flex flex-col">
      ...
      <div className="relative z-20 px-6 py-6">
        <div className="liquid-glass rounded-full max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="text-white font-semibold text-lg ml-2">MyJob</span>
          ...
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-white text-sm font-medium hover:text-white/80 transition-colors">
              Iniciar sesión
            </Link>
            <Link href="/signup" className="liquid-glass rounded-full px-6 py-2 text-white text-sm font-medium hover:bg-white/5 transition-colors">
              Registrarme
            </Link>
          </div>
        </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12 text-center -translate-y-[10%]">
        {/* Heading */}
        <h1
          className="text-7xl md:text-8xl lg:text-9xl text-white tracking-tight mb-8 md:whitespace-nowrap"
        ...
        {/* Subtitle */}
        <p className="text-white/80 text-sm leading-relaxed px-4 max-w-xl mb-8">
